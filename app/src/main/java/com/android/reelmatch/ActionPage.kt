    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val buttonClickListener = View.OnClickListener { v ->
            ...
            when (v.id) {
                ...
                R.id.btn_action -> startActivity(Intent(this, ActionPage::class.java)) // Current page
                ...
                R.id.btn_scifi -> startActivity(Intent(this, ScifiPage::class.java))
